export const data_escova_alisadora = {
    produto: {
        urlVideo: '',
        img: '/assets/img/ofertas/escova_alisadora/escova_1.png',
        ...
        subhead: 'A solução para você modelar seu cabelo em poucos minutos sem sair de casa!',
        btn: 'Comprar Agora',
        ...
        content: [
            {
                ...
                img: "/assets/img/ofertas/escova_alisadora/gif_escova_1.gif",
                content: "A escova alisadora tem cerdas que alisam mechas maiores por vez, reduzindo o número total de passadas pela metade.",
                author: 1,
                likes: 28,
                comments: 0,
                title: "Alisa até 2 vezes mais rápido"
            },
            {
                id: 2,
                ...
                blogType: "grid",
                tags: ["Development", "Events", "Media", "Mountains"],
                img: "/assets/img/ofertas/escova_alisadora/gif_escova_2.gif",
                content: "Alise rente à raiz sem se queimar! A proteção térmica da escova protege o couro cabeludo do calor e evita queimaduras.",
                author: 2,
                likes: 30,
                comments: 0,
                title: "Proteção térmica anti-queimaduras"
            },
            {
                id: 3,
                category: ["NATURE"],
                blogType: "grid",
                tags: ["Development", "Events", "Media", "Mountains"],
                img: "/assets/img/ofertas/escova_alisadora/gif_escova_8.gif",
                content: "A escova alisadora alisa fio por fio na primeira passada, e não expõe o seu cabelo ao calor extra de pranchas tradicionais!",
                author: 3,
                likes: 23,
                comments: 0,
                title: "Reduz os danos e revitaliza os fios"
            },
        ]
    },
    proposta: {
        ...
        content: [
            ...
            {
                title: 'O SEU PROBLEMA', 
                text: 'É a falta de conhecimento sobre estratégias eficazes para criação de um produto ou serviço e dificuldades para atrair parceiros, afiliados ou patrocinadores'
            },
        ]
    },
    cta: {
