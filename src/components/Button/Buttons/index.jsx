  ...
  return (
    (props.href || props.type === "submit") ? (
      ...
      <a
        style={style}
        target={props.target}
        className={`btn cursor-pointer border-[2px] text-xlg font-bold flex items-center justify-center content-center rounded-[25px] btn-${props.size}${props.className ? ' ' + props.className : ''}${typeof (props.themeColor) === "object" ? " btn-gradient" : ""}${typeof (props.color) === "object" ? " text-gradient" : ""} `}
